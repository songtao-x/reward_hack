...
#SBATCH --output=log/rft_full_gradient_bigmath_q2_rloo_base10/%j.out 
#SBATCH --error=log/rft_full_gradient_bigmath_q2_rloo_base10/%j.err

#SBATCH --job-name=rft-full-rloo-g-10
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
#SBATCH --mem=300G
...
sft_output_dir="/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/output/bigmath_rft_full_rloo_base10"
