...
#SBATCH --output=/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/sh_dpo/log/dpo_gradient_arlsat_q3_arlsat_d1_soft_base_majority/%j.out
#SBATCH --error=/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/sh_dpo/log/dpo_gradient_arlsat_q3_arlsat_d1_soft_base_majority/%j.err
#SBATCH --job-name=dpo_base_majority
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
#SBATCH --mem=300G
...
dpo_output_dir="/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/output/arlsat_d1_soft_base_majority"
grpo_output_dir="/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/output/arlsat_d1_soft_base_majority"
