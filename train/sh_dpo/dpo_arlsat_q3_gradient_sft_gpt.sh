...
#SBATCH --output=/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/sh_dpo/log/dpo_gradient_arlsat_q3_arlsat_d1_soft_sft_gpt/%j.out
#SBATCH --error=/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/sh_dpo/log/dpo_gradient_arlsat_q3_arlsat_d1_soft_sft_gpt/%j.err
#SBATCH --job-name=dpo_sft_gpt
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
#SBATCH --mem=300G
...
dpo_output_dir="/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/output/arlsat_d1_soft_sft_gpt"
grpo_output_dir="/home/songtaow/projects/aip-xiye17/songtaow/reward_hack/train/output/arlsat_d1_soft_sft_gpt"
